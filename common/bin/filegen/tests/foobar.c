...
*
* Copyright 2018-2026 [Sibel Inc.], All Rights Reserved.
*
...
*******************************************************************************/
/** @file foobar.c
 *  @brief This is the source file for TODO: ADD INFO
 */
/******************************************************************************
* Includes
*******************************************************************************/
...
* \b Description:
*
* This function is used to initialize the foobar
* @return Nothing
*
* \b Example Example:
* @code
