...
_G.Utils.keymaps.define {
  ...
  { lhs = '<leader>fg', rhs = '<cmd>FzfLua live_grep<cr>',                opts = { desc = 'Grep' } },
  { lhs = '<leader>fG', rhs = '<cmd>FzfLua grep_project<cr>',             opts = { desc = 'Grep Project' } },
  { lhs = '<leader>fg', rhs = '<cmd>FzfLua grep_visual<cr>',              opts = { desc = 'Grep', mode = 'x' } },
  { lhs = '<leader>fd', rhs = '<cmd>FzfLua changes<cr>',                  opts = { desc = 'Changes' } },
