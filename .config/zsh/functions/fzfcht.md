...
KEY/EVENT BINDINGS
       ...
       --bind takes a comma-separated list of binding expressions. Each binding expression is KEY:ACTION or EVENT:ACTION. You can bind actions to multiple keys and event
s by writing comma-separated list of keys and events before the colon. e.g. KEY1,KEY2,EVENT1,EVENT2:ACTION.
